export const blogPosts = [
  {
    ...
    description:
      "Thoughts on how AI tools reshape the way developers build, debug, and ship products.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "How to move fast while keeping architecture clean enough for the next stage.",
  },
];
